...
<div class="row">
							<div class="col-md-offset-2 col-md-8">
                                ...
                                <div class="panel panel-default">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-send"></i><?=$_SESSION['name']?> - <b><?php if(@$lpin){echo $lpin;} ?></h3>
									</div>
                            ...
                            <?php 
								...
								<div class="panel-heading">
								    <h3 class="panel-title"><i class="fa fa-info-circle"></i> Voucher Tersedia</h3></div>
